        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-secondary">
              ...
              Working documents may temporarily reside in SharePoint, but all approved, final versions must be stored in DocuWare.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 border border-border">
                <h4 className="font-semibold text-primary mb-2">SharePoint (Working)</h4>
                <ul className="text-sm text-secondary space-y-1">
